...
struct = full_trial_1.sessions;

% Loop over sessions
for i = 1:length(struct)
    session_idx = struct{i}.session_idx; % Extract session index
    ...
    for d = 1:length(datasets)
        ...
        filename = fullfile(output_folder, sprintf('low_vel_neural_plot_%s_session_%d.png', dataset_name, session_idx));
